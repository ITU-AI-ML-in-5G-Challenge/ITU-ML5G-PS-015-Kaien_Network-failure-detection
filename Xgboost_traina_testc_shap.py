...
train = df[(df['traintest']==0) & (df['abc']=='a')]  #a,c
test = df[(df['traintest']==1) & (df['abc']=='c')] #a,c
...
print('----------- shap feature value for root cause analysis  ---------------')

xgb_explainer = shap.TreeExplainer(rfcbuild)
...
print('--------------- shap successful completed------------------')
